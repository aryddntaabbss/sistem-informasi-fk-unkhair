<x-dashboard-layout>
    <x-slot name="contentHeader">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Program Doktor</h1>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('doktor') }}">Program Doktor</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('edit-doktor') }}">Edit</a></li>
                    </ol>
                </div>
            </div>
    ...
    <form id="update-departemen" method="post" action="{{ route('update-doktor') }}" enctype="multipart/form-data">
        @csrf
        @method('put')
