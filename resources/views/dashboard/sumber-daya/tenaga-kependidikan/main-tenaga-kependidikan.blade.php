<x-dashboard-layout>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('tenaga-kependidikan') }}">Tenaga Kependidikan</a>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="container pb-2">
        ...
        <!-- Create Modal -->
        @include('dashboard.sumber-daya.tenaga-kependidikan.create-modal')

        <div class="card mt-3">
            <div class="card-header">
                <h2 class="text-lg font-medium text-gray-900">
                    {{ __('Tabel Data Tenaga Kependidikan') }}
                </h2>
            </div>
                    ...
                    <table id="tabelGuruBesar" class="table table-stripped table-sm align-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="align-middle">{{ $a->jabatan }}</td>
                                ...
                                <td class="align-middle">
                                    ...
                                    @include('dashboard.sumber-daya.tenaga-kependidikan.update-modal')
                                    @include('dashboard.sumber-daya.tenaga-kependidikan.delete-modal')
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
