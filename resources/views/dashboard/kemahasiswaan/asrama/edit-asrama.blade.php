<x-dashboard-layout>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('asrama') }}">UPT Asrama</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('edit-asrama') }}">Edit</a></li>
                    </ol>
                </div>
            </div>
    ...
    <form id="update-asrama" method="post" action="{{ route('update-asrama') }}" enctype="multipart/form-data">
        @csrf
        @method('put')
