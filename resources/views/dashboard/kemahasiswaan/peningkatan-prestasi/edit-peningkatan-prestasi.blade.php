<x-dashboard-layout>
    <x-slot name="contentHeader">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Peningkatan Prestasi Mahasiswa</h1>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('peningkatan-prestasi') }}">Peningkatan Prestasi
                                Mahasiswa</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('edit-peningkatan-prestasi') }}">Edit</a></li>
                    </ol>
                </div>
            </div>
    ...
    <form id="update-asrama" method="post" action="{{ route('update-peningkatan-prestasi') }}"
