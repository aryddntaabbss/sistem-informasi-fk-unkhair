<x-dashboard-layout>
    <x-slot name="contentHeader">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Aturan Kemahasiswaan</h1>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('aturan') }}">Aturan Kemahasiswaan</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('edit-aturan') }}">Edit</a></li>
                    </ol>
                </div>
            </div>
    ...
    <form id="update-asrama" method="post" action="{{ route('update-aturan') }}" enctype="multipart/form-data">
        @csrf
        @method('put')
