<x-dashboard-layout>
    <x-slot name="contentHeader">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Daftar Penelitian</h1>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('daftar-penelitian') }}">Daftar Penelitian</a>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="container pb-2">
        ...
        <!-- Create Modal -->
        @include('dashboard.riset-inovasi.daftar-penelitian.create-modal')

        <div class="card mt-3">
            <div class="card-header">
                <h2 class="text-lg font-medium text-gray-900">
                    {{ __('Tabel Data Penelitian') }}
                </h2>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="align-middle">
                                    ...
                                    @include('dashboard.riset-inovasi.daftar-penelitian.update-modal')
                                    @include('dashboard.riset-inovasi.daftar-penelitian.delete-modal')
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
